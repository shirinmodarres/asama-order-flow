  ...
  return (
    <div className="rounded-[12px] border border-[#E5E7EB] bg-white p-5 shadow-sm">
      ...
      <dl className="mt-4 grid gap-3 sm:grid-cols-2 text-sm">
        ...
        <Item label="زمان تحویل" value={deliveredAt ? formatDateTime(deliveredAt) : "-"} />
      </dl>
      <div className="mt-4 rounded-[12px] border border-[#E5E7EB] bg-[#FBFCFD] p-3 text-sm text-[#475569]">{notes || "توضیحی ثبت نشده است."}</div>
    </div>
  );
}

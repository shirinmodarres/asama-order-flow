  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0F172A]/40 p-4">
      <form
        ...
        className="w-full max-w-md rounded-xl border border-[#E5E7EB] bg-white p-5 shadow-sm"
      >
        ...
        <div className="mt-4 grid gap-3">
          <label className="grid gap-1 text-sm text-[#334155]">
            ...
            <select
              value={changeType}
              onChange={(event) =>
                setChangeType(event.target.value as "increase" | "decrease")
              }
          ...
          <label className="grid gap-1 text-sm text-[#334155]">
            ...
            <textarea
              ...
              className="min-h-20 rounded-xl border border-[#E5E7EB] px-3 py-2 outline-none focus:border-[#1F3A5F]"
            />
          </label>
        </div>
